...
$query=$conn->prepare("select product_name,code,status,purchasing_price,selling_price,DATE_FORMAT(expire_date, '%M %e, %Y')as expire_date,expected_profit,date,tax_collected from products");
